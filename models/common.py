...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, val=False):
        ...
        if self.pt:  # OneFlow
            ...
            im = im.cpu().numpy()  # oneflow to numpy
            ...
            im = im.permute(0, 2, 3, 1).cpu().numpy()  # oneflow BCHW to numpy BHWC shape(1,320,192,3)
...
class AutoShape(nn.Module):
    # YOLOv5 input-robust model wrapper for passing cv2/np/PIL/oneflow inputs. Includes preprocessing, inference and NMS
    ...
    def __init__(self, model, verbose=True):
        ...
        self.pt = not self.dmb or model.pt  # OneFlow model
    ...
    def forward(self, imgs, size=640, augment=False, profile=False):
        ...
        #   oneflow:           = flow.zeros(16,3,320,640)  # BCHW (scaled to size=640, 0-1 values)
