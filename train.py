...
Usage - Multi-GPU DDP training:
    $ python -m oneflow.distributed.run --nproc_per_node 4 --master_port 1 train.py --data coco128.yaml --weights yolov5s.pt --img 640 --device 0,1,2,3
...
from utils.temp_repair_tool import (
    FlowCudaMemoryReserved,
    model_save,
    load_torch_pretrained,
)
...
def main(opt, callbacks=Callbacks()):
    ...
    if LOCAL_RANK != -1:
        ...
        assert (
            flow.cuda.device_count() > LOCAL_RANK
