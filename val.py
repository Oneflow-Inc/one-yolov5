    ...
    with flow.no_grad():
        for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
            ...
            for si, pred in enumerate(out):
                ...
                predn[:, :4] = scale_coords(im[si].shape[1:], predn[:, :4], shapes[si][0], shapes[si][1])  # native-space pred
                if nl:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp302/weights/last.pt', help='model path(s)')
